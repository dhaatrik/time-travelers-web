    ...
    >
      ...
      >
        ...
        <div className="text-sm md:text-base space-y-3">
          ...
          <h3 className={sectionTitleClass}>Credits</h3>
          <p>
            Created by <strong>Dhaatrik Chowdhury</strong>. View the source on{' '}
            <a href="https://github.com/dhaatrik/time-travelers-web" target="_blank" rel="noopener noreferrer" className={eraTheme.linkColor}>GitHub</a>.
          </p>
        </div>
      </div>
    </div>
